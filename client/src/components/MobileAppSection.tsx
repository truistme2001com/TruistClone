            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                <Button 
                  ...
                  asChild
                >
                  <a href="https://apps.apple.com/us/app/truist-mobile-banking/id1495627464" target="_blank" rel="noopener noreferrer">
                ...
                <Button 
                  ...
                  asChild
                >
                  <a href="https://play.google.com/store/apps/details?id=com.truist.androidmobileapp" target="_blank" rel="noopener noreferrer">
                    <div className="flex items-center gap-2 px-4 py-2">
                      <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
