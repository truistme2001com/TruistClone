    ...
    <footer className="bg-[#2D1B4E] text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="flex flex-wrap justify-center gap-6 mb-12 text-sm border-b border-white/20 pb-8">
          <a href="#" className="text-white/90 hover:text-white hover:underline transition-colors">Privacy</a>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Commercial</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Credit cards</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Loans</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Mortgage</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Online & mobile</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Open an account</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Savings</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Small business</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Truist Foundation</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Truist Leadership Institute</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Truist Securities</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Accessibility</a></li>
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Client emergency resources</a></li>
              ...
              <li><a href="#" className="text-white/80 hover:text-white hover:underline transition-colors">Schedule a branch appointment</a></li>
